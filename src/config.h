...
#define DEBUG_SERVOS    1       // Output the servo values to the serial monitor

// ESP Pin definitions
#define PIN_JOYSTICK_X 1        // Joystic X-axis
#define PIN_JOYSTICK_Y 0        // Joystick Y-axis
...
// Lower = more down, Higher = more up
#define SERVO_TILT_MIN 350
#define SERVO_TILT_MAX 580
// Lower = more open, Higher = more closed
#define SERVO_LEFT_LID_TOP_OPEN 180
#define SERVO_LEFT_LID_TOP_CLOSED 340
// Lower = more closed, Higher = more open
#define SERVO_LEFT_LID_BOTTOM_OPEN 550
#define SERVO_LEFT_LID_BOTTOM_CLOSED 290
// Lower = more closed, Higher = more open
#define SERVO_RIGHT_LID_TOP_OPEN 600
#define SERVO_RIGHT_LID_TOP_CLOSED 400
// Lower = more open, Higher = more closed
#define SERVO_RIGHT_LID_BOTTOM_OPEN 250
#define SERVO_RIGHT_LID_BOTTOM_CLOSED 500
